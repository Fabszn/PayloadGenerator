...
import shapeless.{:+:, ::, CNil, Coproduct, HList, HNil, Inl, Inr, LabelledGeneric, Lazy, MkFieldLens, Witness}
...
object Main extends App {
  ...
  case class Client(name: String,partenaire: Partenaire)

  case class Mission(id: Int, name: String, dateCreation: LocalDate)

  case class Payload(mission: Mission, client: Client)
